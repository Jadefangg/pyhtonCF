...
class Recipe(Base):
    ...
    def __repr__(self):                                          #this method is used to return a string representation of the object. It is being used because it is easier to read than the default representation. 
...
def delete_recipe():
    ...
    if confirm.lower() != 'yes':      #if the input is not yes, the deletion will not go through.
    ...
    try:
        ...
        session.rollback()                     #roll back serves the purpose of undoing the changes made to the database. 
